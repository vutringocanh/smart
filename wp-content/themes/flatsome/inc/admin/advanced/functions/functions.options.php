...
$of_options[] = array( 	"name" 		=> "VIFONIC 2.0 Content Support",
						"id" 		=> "flatsome_fallback",
						"desc"      => "Support content made in VIFONIC 2.0. Disable to speed up site.",
						"std" 		=> 1,
						"type" 		=> "checkbox"
);
...
$of_options[] = array( 	"name" 		=> "Add custom fonts",
						"type" 		=> "info",
						"desc" => '<p style="font-size:16px">We are working on a new solution for adding custom fonts to VIFONIC. Meanwhile follow this guide: <a href="//uxthemes.helpscoutdocs.com/article/224-add-custom-fonts-to-flatsome" target="_blank">Add Custom fonts to VIFONIC</p></a>'
);
