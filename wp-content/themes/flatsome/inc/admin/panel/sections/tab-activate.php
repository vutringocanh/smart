...
<div id="tab-activate" class="col cols panel flatsome-panel">
    ...
    if ( ! empty( $purchase_code ) ) {
      if ( ! empty( $errors ) ) {
       ...
       echo '<div class="notice-success notice-alt notice-large" style="margin-bottom:15px!important">' . __( 'Your <strong>purchase code is valid</strong>. Thank you! Enjoy VIFONIC Theme and automatic updates.' ) . '</div>';
      }
    }
