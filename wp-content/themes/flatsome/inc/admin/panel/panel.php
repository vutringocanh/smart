...
class Flatsome_Admin {
	...
	public function flatsome_panel_register_menu() {
		...
		add_menu_page( 'Welcome to VIFONIC', 'VIFONIC', 'manage_options', 'flatsome-panel', array( $this, 'flatsome_panel_welcome_vifonic' ), get_template_directory_uri().'/assets/img/logo-icon.svg', '2');
